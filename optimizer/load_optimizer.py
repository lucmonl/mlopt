...
def load_optimizer(opt_name, model, lr, momentum, weight_decay, lr_decay, epochs_lr_decay, **kwargs):
...
def load_optimizer_from_args(opt_name, model, lr, momentum, weight_decay, lr_decay, epochs_lr_decay, **kwargs):
    if opt_name == "sgd" or opt_name == "gd":
        optimizer = optim.SGD(model.parameters(),
                            lr=lr,
                            momentum=momentum,
