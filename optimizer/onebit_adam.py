...
OneBit_Adam.__doc__ = r"""Implements Adam algorithm.
    ...
    for ((
        ...
        if capturable:
            ...
            if beta2 != 1:
                ...
                bias_correction2 = [1 for step in device_state_steps]
            """
            bias_correction1 = [1 for step in device_state_steps]
            bias_correction2 = [1 for step in device_state_steps]
