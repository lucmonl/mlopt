...
def _single_tensor_adam(params: List[Tensor],
    ...
    for i, param in enumerate(params):
        ...
        #exp_avg_sq.mul_(beta2).add_(torch.maximum(grad_sq, torch.ones_like(grad_sq)*1e-6), alpha=1 - beta2)
        ...
        if capturable or differentiable:
            ...
            if amsgrad:
                ...
                denom = (torch.maximum(grad_sq, torch.ones_like(grad_sq)*1e-8).sqrt() / bias_correction2_sqrt).add_(eps)
