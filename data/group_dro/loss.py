...
class LossComputer:
    def __init__(self, criterion, is_robust, n_groups, group_counts, group_str, alpha=None, gamma=0.1, adj=None, min_var_weight=0, step_size=0.01, normalize_loss=False, btl=False):
