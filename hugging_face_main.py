...
def analysis(graphs, analysis_list, model, model_name, loss_name, criterion, criterion_summed, device, num_classes, train_loader, test_loader, analysis_loader, analysis_eval_loader, weight_decay=0, batch_size=None, adv_eta=None):
        ...
        def on_epoch_end(self, args: TrainingArguments, state: TrainerState, control: TrainerControl, **kwargs):
            ...
            if int(state.epoch) in epoch_list:
                analysis(train_graphs,
                        ...
                        analysis_eval_loader=kwargs["analysis_eval_dataloader"], 
                        weight_decay=training_args.weight_decay,
